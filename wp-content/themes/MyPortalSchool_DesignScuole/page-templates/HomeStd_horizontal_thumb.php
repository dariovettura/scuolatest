<?php
/* Template Name: HomeStd con widget
 *
        ...
        if ( have_posts() ) :
           ...
           $home_is_selezione_automatica = dsi_get_option("home_is_selezione_automatica", "homepage");
            ...
            if($home_is_selezione_automatica == "true_horizontal") {
                get_template_part("template-parts/home/novita", "orizzontale-oriz-thumb");
            }else if($home_is_selezione_automatica != "false") {
                get_template_part("template-parts/home/novita", "verticale-oriz-thumb");
            }
		?>
