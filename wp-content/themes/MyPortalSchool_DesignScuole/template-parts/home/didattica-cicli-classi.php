                            ...
                            ?>
                                <div id="tab-<?php echo $idstruttura; ?>" class="responsive-tabs-content">
                                    <div class="accordion-large accordion-wrapper">
                                        ...
                                        <a class="btn btn-redbrown mt-4" 
href="<?php echo home_url(get_percorso() . 'struttura/' . basename(get_permalink($idstruttura))); ?>"
  
>
><?php _e("Vai alla presentazione della Scuola", "design_scuole_italia"); ?></a>
