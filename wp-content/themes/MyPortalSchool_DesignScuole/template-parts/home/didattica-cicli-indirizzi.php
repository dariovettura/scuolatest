...
function get_percorso() {
global $wp;
    $current_url = esc_url(home_url(add_query_arg(array(), $wp->request)));
    // Verifica se l'URL termina con "offerta-formativa"
 if (strpos($current_url, '/offerta-formativa') !== false)  {
        // Se sì, restituisci il percorso modificato
        return '/didattica/offerta-formativa/';
    } else {
        // Se no, restituisci il percorso originale
        return '/didattica/';
    }
}
        ...
        <div class="container">
            <div class="row variable-gutters">
                <div class="col">
                    ...
                    <div class="tabs-img">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/didattica-mockup.png" alt="didattica mockup">
                    </div>
                                                    ...
                                                    <div class="row variable-gutters">
                                                        ...
                                                        ?>
                                                                    <div class="col-lg-6  d-flex mb-2 ">
                                                                        <a 
href="<?php echo home_url(get_percorso() . 'indirizzo/' . basename(get_permalink($idindirizzo))); ?>"



 class="btn btn-redbrown" style="text-decoration:none;"><?php echo get_the_title($idindirizzo) ?></a>
                                                                    </div>
                                                            ...
                                                            if ($count_indirizzi_in_percorso_selezionato == 0) { ?>
                                                                <div class="col-lg-6 d-flex">
                                                                    ...
                                                                    <a href="<?php echo home_url(get_percorso() . 'struttura/' . basename(get_permalink($struttura))); ?>"

																		
																		class="btn btn-bluelectric" style="background-color:#0a00cb; text-decoration:none;"><?php _e("Per saperne di più", "design_scuole_italia"); ?></a>
                                                                </div>
