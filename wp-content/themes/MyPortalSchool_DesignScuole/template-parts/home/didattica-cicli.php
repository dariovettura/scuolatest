        ...
        <div class="container">
            <div class="row variable-gutters">
                                    ...
                                    <div class="accordion-large accordion-wrapper">
                                        ...
                                        ?>
                                                    ...
                                                    <div tabindex="0" class="accordion-large-content accordion-content">
                                                        ...
                                                        <p><a href="<?php echo home_url(get_percorso() . 'indirizzo/' . basename(get_permalink($indirizzo))); ?>"
             ...
             <div class="text-center text-sm-left">
                      <a class="btn btn-redbrown mt-4 mb-2" href="<?php echo home_url(get_percorso() . 'struttura/' . basename(get_permalink($idstruttura))); ?>"
                       >
                        <?php _e("Vai alla presentazione della scuola", "design_scuole_italia"); ?>
                      </a>
                    </div>
