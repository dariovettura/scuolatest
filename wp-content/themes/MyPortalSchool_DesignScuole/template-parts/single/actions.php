                                    ...
                                    <li>
                                        <a class="list-item" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode($current_uri); ?>&title=<?php echo urlencode($current_title); ?>&source=<?php echo dsi_get_option("nome_scuola"); ?>" title="<?php _e("Condividi su", "design_scuole_italia"); ?>: Linkedin"  target="_blank">
                                            ...
                                            <span>Linkedin</span>
																		 ...
																		 <li>
                                   <a class="list-item" href="whatsapp://send?text=<?php echo get_the_title() . '%0A%0A' . urlencode( get_the_permalink() ); ?>&title=<?php echo urlencode($current_title); ?>&source=<?php echo dsi_get_option("nome_scuola"); ?>" title="<?php _e("Condividi su", "design_scuole_italia"); ?>: Whatsapp"  target="_blank">
									   									   <img class="icon" src="<?= get_stylesheet_directory_uri() . '/assets/icons/it-whatsapp.svg'; ?>">
									   <span>Whatsapp</span>
                                        </a>
                                    </li>
                                </ul>
